...
for seq_id, sequence_name in enumerate(sequence_names):
	...
	if '202012' in sequence_name:
		phoneID_mapping = {'Hansi': 'A', 'Mohamed': 'B', 'Hongyu': 'C', 'Sid': 'D', 'Murtadha': 'E', 'None': 'N/A'}
	else:
		phoneID_mapping = {'Hansi': 'A', 'Nicholas': 'B', 'Bo': 'C', 'Sid': 'D', 'Murtadha': 'E', 'Others': 'Others', 'None': 'N/A'}
	...
	# col_id_dict = {0: 'Hongyu', 1: 'Hansi', 2: 'Mohamed'}
	# col_id_dict = {}
	ftm_csv_dicts = {}
